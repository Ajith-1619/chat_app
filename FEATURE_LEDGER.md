...
- Horizon employee route modal map implemented in lib/myhub_horizon_screen.dart.


# HORIZON-MODAL-MAP-2026-08-06
- Full-map employee route modal with fixed details header and map-only content.


# MYHUB-WORKSPACE-UI-2026-08-06
- Responsive My Hub action-card grid and scrollbar-enabled Workspace filter rail.
