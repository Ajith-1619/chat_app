...
$notes = implode("
", [
    'v2.0.2 multi-platform draft build.',
    'Includes clipboard file paste fixes, text selection/copy fixes, contact sharing, checklist attachment action, channel date pickers, and latest chat/file/location/task updates.',
    'Windows artifact is an installer EXE, not a zip package.',
    'This build is Draft only. Force update is disabled. Production deployment requires Ajith (Employee ID 302) approval.',
]);

$builds = [
    ['android', '2.0.2', 25, 'https://dns.watchtower247.in/router_login/downloads/Skylink-Chat-v2.0.2.apk'],
    ['windows', '2.0.2', 25, 'https://dns.watchtower247.in/router_login/downloads/Skylink-Chat-Setup-v2.0.2.exe'],
    ['web', '2.0.2', 25, 'https://dns.watchtower247.in/router_login/downloads/Skylink-Chat-Web-v2.0.2.zip'],
];
...
foreach ($builds as $build) {
    ...
    $hist = $pdo->prepare(
        "INSERT INTO xmpp_release_history
         ...
         'Auto-registered v2.0.2 draft after artifact upload')"
    );
    $hist->execute([':id' => $id]);
