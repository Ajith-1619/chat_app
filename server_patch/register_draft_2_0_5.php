...
$notes = implode("
", [
    'v2.0.5 Android draft build generated on 2026-07-24.',
    'Includes latest Flow chat fixes and channel next-action badge updates from the current workspace.',
    'Includes current Android app improvements present in the workspace build.',
...
$builds = [
    ['android', '2.0.5', 28, 'https://dns.watchtower247.in/router_login/downloads/Skylink-Chat-v2.0.5.apk'],
];
    ...
    if ($id > 0) {
        $hist = $pdo->prepare(
            "INSERT INTO xmpp_release_history
             ...
             'Auto-registered v2.0.5 Android draft after artifact upload')"
        );
        $hist->execute([':id' => $id]);
    }
