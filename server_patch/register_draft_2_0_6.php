...
$notes = implode("\n", [
    'v2.0.6 Android draft build generated on 2026-07-25.',
    'Includes mobile composer responsive cleanup and Enter-to-send user preference.',
    'Includes current Flow chat, folder persistence, AI access, and performance updates present in the workspace build.',
    'Android artifact is release APK.',
...
$builds = [
    ['android', '2.0.6', 29, 'https://dns.watchtower247.in/router_login/downloads/Skylink-Chat-v2.0.6.apk'],
];
    ...
    if ($id > 0) {
        $hist = $pdo->prepare(
            "INSERT INTO xmpp_release_history
             ...
             'Auto-registered v2.0.6 Android draft after artifact upload')"
        );
        $hist->execute([':id' => $id]);
    }
